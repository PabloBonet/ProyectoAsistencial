...
CREATE TABLE `beneficiario_beneficio` (
  `id_benef_beneficio` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `beneficiario_beneficio` (`id_benef_beneficio`,`id_beneficiario`,`id_beneficio`,`fechadesde`) VALUES 
 (1,2,1,'2018-08-13 00:00:00'),
 (2,1,2,'2018-08-13 00:00:00'),
 (3,2,2,'2018-08-13 00:00:00');
...
INSERT INTO `beneficio` (`id_beneficio`,`nombre`,`descripcion`) VALUES 
 (1,'ASIGNACIÓN POR HIJO','ASIGNACIÓN POR HIJOS'),
 (2,'PENSIÓN','PENSIÓN');
...
INSERT INTO `funcion` (`id_funcion`,`id_menu`,`nombre_funcion`,`nombre_menu`) VALUES 
 ...
 (41,2,'btnNuevoBeneficio','tabBeneficiarios'),
 (42,2,'btnAdministrarBeneficio','tabBeneficiarios');
